...
from paje.component.modelling.classifier.classifier import Classifier
...
class DT(Classifier):
    ...
    def hps_impl(cls, data):
        ...
        dic = {
            ...
            'min_weight_fraction_leaf': ['r', 0, 0.5],  # According to ValueError exception (tested only with RF).
            'max_features': ['r', 0.001, 1],  # For some reason, the interval [1, n_attributes] didn't work for DT.
            'max_leaf_nodes': ['o', [2, 4, 7, 11, 16, 22, 29, 37, 46, 56, 999999]],  # 999999 ~ None
